...
namespace fltstd26.system
{
    public static class AutoAct
    {
        ...
        */
        ...
        /// Action Codes:
        /// 0 - Full DB Restore, (Not implemented)
        /// 1 - Insert,
        /// 2 - Delete,
        /// 3 - Update,
        /// 4 - Config Update
        ...
        public static void PushAction(DatabaseAction? a,List<DatabaseAction>? s = null)
        {
            ...
            {
                ConProc.Log("[AUTOACT] Error trying to push action: " + ex.Message);
            }
        }
        ...
        public static void Clear()
        {
            ...
            RedoLock = false;
            UndoLock = false;
            ConProc.Log("[AUTOACT] History cleared");
        }
        ...
        public static bool Undo()
        {
            try
            {
                if (ActionStack.TryPeek(out List<DatabaseAction>? SingleStack) && SingleStack != null)
                {
                    ...
                    List<int> ids = Act(SingleStack,true) ?? throw new Exception("Act already failed");
            ...
            {
                ConProc.Log("[AUTOACT] Error trying to undo action: " + ex.Message);
            }
        ...
        public static bool Redo()
        {
            ...
            {
                ConProc.Log("[AUTOACT] Error trying to redo action: " + ex.Message);
            }
                ...
                for (int i = actions.Count - 1; i >= 0; i--)
                {
                    ...
                    switch (undo ? Reversed[actions[i].ActionID] : actions[i].ActionID)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            object? set = USettings.UpdateSetting(actions[i].ForeignKeyName,undo ? actions[i].PreviousValue : actions[i].CurrentValue,actions[i].DataType);
                            break;
                    }
    ...
    public record DatabaseAction
    {
        ...
        public string? ForeignKeyName { get; init; } // PROP NAME ON CONFIG CHANGE
